...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                ...
                || OfferPreferenceFragment.class.getName().equals(fragmentName);
    }
    ...
    /**
     * This fragment shows layout preferences only. It is used when the
     * activity is showing a two-pane settings UI.
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class OfferPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_offer);
            setHasOptionsMenu(true);

            /* Bind the summaries of EditText/List/Dialog/Ringtone preferences
             * to their values. When their values change, their summaries are
             * updated to reflect the new value, per the Android Design guidelines */
            bindPreferenceSummaryToValue(findPreference("offer_columns_portrait"));
            bindPreferenceSummaryToValue(findPreference("offer_columns_landscape"));
        }
